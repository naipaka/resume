...
- 個人開発： MAU 2 万超のアプリを 5 年以上運用、登録ユーザー18 万人超
...
| Kotlin / Java        | 1年      | BtoB システムの保守や FMethod Channel を使用したネイティブ連携機能の実装                                                                                             |
...
Flutter/Dart を中心に、自社開発・受託開発の双方で 0→1 の新規開発からリプレイスまで担当してきました。
...
- Custom Lint / Analyzer Plugin の作成によるコード品質の標準化
- OpenAPI を用いた API Client / Postman Collection の自動生成
- Dart CLI を用いた開発支援ツールの作成

#### 開発プロセス改善

- 質問テンプレート整備と短期集中フィードバックによる新人の立ち上げ支援
- モブプログラミングレビュー制度の導入
...
MAU500 万人規模のアプリの開発やプロトタイプ開発、新規サービス立ち上げなど多様なプロジェクトに参画しました。

CI/CD 環境構築、Flutter 未経験者への研修プログラム策定、コードレビュー基準整備を担当しました。

また、副業や個人開発で培ったノウハウを社内へ展開し、ウィジェット分割や便利なパッケージ紹介、Git エイリアス共有など、開発効率化に貢献することを心がけました。
