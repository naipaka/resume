...
- これまでの経験がフルに生かしつつ、サービスを成長させていきたいです
...
- 自分で自信を持って出したプロダクトに関しては競合に負けたくないというモチベーションでプロダクト開発をします
  - 個人開発で出しているアプリのうち 2 つは、主要な検索キーワードで 1 位を獲得しています
- 業務外での開発を通じて得た知見を共有してチームに貢献することが好きです
- 仕事の効率を上げるために隙間時間で役に立ちそうなツールを作ったりするのが好きです
- 心理的安全性が高い場所だと仕事のパフォーマンスが発揮できます
  - 誰もが意見を言っている、レビューの指摘にトゲがない、チームのメンバーが信頼できる、など
  - 逆に周りが萎縮してしまうような事柄が発生する場所では仕事がしづらいです
