...
| :-------------------------------------------- | :------- | :------------------------------------------- | :------------------------------------------- | :---------------------------------------------- | :------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 医療従事者向けアプリ開発<br>(2024/11〜現在)   | 常駐開発 | アプリ開発 3-4名<br>サーバーサイド開発チーム | 開発メンバー<br>(設計、実装、テスト)         | - Flutter<br>- Laravel API                      | - 既存アプリのリプレイス開発<br>- Laravel APIとの連携                                                          | - OpenAPI定義からのAPI Client自動生成<br>- Postman Collection生成パッケージの開発<br>- 技術的課題の解決とチーム全体での知見共有                                  |
